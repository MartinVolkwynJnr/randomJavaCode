...
public class RotationRulesTest {
    ...
    public void rotateSideProvidedLetterU() {
        ...
        cubeState.setDefaultMixSolvedCube();

        CubeState cubeResult = rotationRules.rotateSideProvidedLetter('U',cubeState);

        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getLeft()[0][2]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getLeft()[1][2]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getLeft()[2][2]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getBack()[2][0]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getBack()[2][1]);
        ...
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getFront()[0][1]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getFront()[0][2]);
    }
    ...
    public void rotateSideProvidedLetterUCounter() {
        ...
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getBack()[2][1]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getBack()[2][2]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getRight()[0][0]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getRight()[1][0]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getRight()[2][0]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getFront()[0][0]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getFront()[0][1]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getFront()[0][2]);
    }
    ...
    public void rotateSideProvidedLetterD() {
        ...
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getLeft()[0][0]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getLeft()[1][0]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getLeft()[2][0]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getBack()[0][0]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getBack()[0][1]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getBack()[0][2]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getRight()[0][2]);
        ...
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getFront()[2][0]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getFront()[2][1]);
    ...
    public void rotateSideProvidedLetterDCounter() {
        ...
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getBack()[0][0]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getBack()[0][1]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getBack()[0][2]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getRight()[0][2]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getRight()[1][2]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getRight()[2][2]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getFront()[2][0]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getFront()[2][1]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getFront()[2][2]);
    }
    ...
    public void rotateSideProvidedLetterF() {
        ...
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getLeft()[2][0]);
        ...
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getUpper()[2][1]);
        ...
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getDown()[2][1]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getDown()[2][2]);
    }
    ...
    public void rotateSideProvidedLetterFCounter() {
        ...
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getRight()[2][0]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getRight()[2][1]);
    ...
    public void rotateSideProvidedLetterB() {
        ...
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getRight()[0][2]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getDown()[0][0]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getDown()[0][1]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getDown()[0][2]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getLeft()[0][0]);
        ...
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getUpper()[0][1]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getUpper()[0][2]);
    }
    ...
    public void rotateSideProvidedLetterBCounter() {
        ...
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getLeft()[0][0]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getLeft()[0][1]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getLeft()[0][2]);
        ...
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getRight()[0][1]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getRight()[0][2]);
        Assert.assertEquals(CubeColours.RED.ordinal(), cubeResult.getDown()[0][0]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getDown()[0][1]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getDown()[0][2]);
    }
    ...
    public void rotateSideProvidedLetterR() {
        ...
        Assert.assertEquals(CubeColours.WHITE.ordinal(), cubeResult.getDown()[0][0]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getDown()[1][0]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getDown()[2][0]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getBack()[0][2]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getBack()[1][2]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getBack()[2][2]);
    }
    ...
    public void rotateSideProvidedLetterRCounter() {
        ...
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getUpper()[0][2]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getUpper()[1][2]);
        Assert.assertEquals(CubeColours.WHITE.ordinal(), cubeResult.getUpper()[2][2]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getFront()[0][2]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getFront()[1][2]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getFront()[2][2]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getDown()[0][0]);
    ...
    public void rotateSideProvidedLetterL() {
        ...
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getUpper()[1][0]);
        Assert.assertEquals(CubeColours.WHITE.ordinal(), cubeResult.getUpper()[2][0]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getFront()[0][0]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getFront()[1][0]);
        Assert.assertEquals(CubeColours.WHITE.ordinal(), cubeResult.getFront()[2][0]);
        Assert.assertEquals(CubeColours.WHITE.ordinal(), cubeResult.getDown()[0][2]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getDown()[1][2]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getDown()[2][2]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getBack()[0][0]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getBack()[1][0]);
    ...
    public void rotateSideProvidedLetterLCounter() {
        ...
        Assert.assertEquals(CubeColours.WHITE.ordinal(), cubeResult.getDown()[0][2]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getDown()[1][2]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getDown()[2][2]);
        Assert.assertEquals(CubeColours.GREEN.ordinal(), cubeResult.getFront()[0][0]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getFront()[1][0]);
        Assert.assertEquals(CubeColours.YELLOW.ordinal(), cubeResult.getFront()[2][0]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getUpper()[0][0]);
        Assert.assertEquals(CubeColours.ORANGE.ordinal(), cubeResult.getUpper()[1][0]);
        Assert.assertEquals(CubeColours.WHITE.ordinal(), cubeResult.getUpper()[2][0]);
        Assert.assertEquals(CubeColours.BLUE.ordinal(), cubeResult.getBack()[0][0]);
    ...
    @Test
    public void testPatternRRURUrururUr(){
        //RUrURUUr
        RubikCycle rubikCycle = new RubikCycle();
        rubikCycle.cubeState.setDefaultSolvedCube();
        int result = rubikCycle.getNumberOfSequenceRequiredToOriginalState("RRURUrururUr");
